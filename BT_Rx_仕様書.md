...
| C6 | 100µF 16V | OSコン φ6.3×6mm (SEPC) | オーディオ Lch DCブロッキングコンデンサ（手はんだ）。導電性高分子アルミ固体電解、ESR 24mΩ、ピッチ2.5mm。フットプリントφ4だがリード曲げで実装 |
| C7 | 100µF 16V | OSコン φ6.3×6mm (SEPC) | オーディオ Rch DCブロッキングコンデンサ（手はんだ）。導電性高分子アルミ固体電解、ESR 24mΩ、ピッチ2.5mm。フットプリントφ4だがリード曲げで実装 |
